...
return new class extends Migration {
    ...
    public function up(): void
    {
        ...
        Schema::table($tableNames['invoice_payment_types'], function (Blueprint $table) use ($tableNames) {
            $table->string('sat_code', 5)->default('')->after('name');
        });

        Schema::table($tableNames['invoice_types'], function (Blueprint $table) use ($tableNames) {
            $table->string('sat_code', 5)->default('')->after('name');
        });
